...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51619b2e511a8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51619b2e511a8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_diextra/doctrine/EntityManager_51619b2e511a8.php';
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51619b2e511a8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/Resources/views');
     ...
     *
     * @return EntityManager51619b2e511a8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev',
            'kernel.logs_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/logs',
            ...
            'debug.container.dump' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/profiler',
            ...
            'router.resource' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/../web',
            'assetic.write_to' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_diextra/doctrine/EntityManager_51619b2e511a8.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51619b2e511a8_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/opt/local/apache2/htdocs/Symfony2-RESTAPI/app/cache/dev/jms_security',
